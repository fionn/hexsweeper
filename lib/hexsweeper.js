...
Hexsweeper.prototype=Object.create(Game.prototype,{
	...
	onMouseUpAfter:{value:function(ev){
		if(this.mouse_button==0 || this.mouse_button>=4) return
		if(this.game_over) {
			return this.reset()
		}
	...
	update:{value:function() {
		if(this.mouse_down_time==0)
			...
			this.effective_mouse_down=((this.mouse_button>>1)+t+this.mouse_down_mod)%2+1
		}
	}},
});
