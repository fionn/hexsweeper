...
Hexsweeper.prototype=Object.create(Game.prototype,{
	...
	renderUI:{value:function(){
		...
		if(this.game_over) {
			this.ui_context.r.shadowBlur=0.1;
			this.ui_context.r.shadowColor='#FFF';
			this.ui_context.r.fillHexagon(this.ui_context.r.toRel(0,1.15),0.05);
		} else
			this.ui_context.r.strokeHexagon(this.ui_context.r.toRel(0,1.15),0.05);
	
		this.ui_context.r.restore();
	}},
	...
	update:{value:function() {
		if(this.mouse_down_time==0)
			...
			this.effective_mouse_down=((this.mouse_button>>1)+t)%3+1
		}
	}},
});
